...
export default function ProductListing() {
	...
	if (isLoading)
		return (
			<div className='w-[85%] m-auto py-10 text-center'>
				Loading products...
			</div>
		)
	if (error)
		return (
			<div className='w-[85%] m-auto py-10 text-center text-red-500'>
					...
					<div className='space-y-6'>
						<div className='flex items-center justify-between'>
							...
							<button
								...
								onClick={() =>
									setViewMore({ ...viewMore, categories: !viewMore.categories })
								}
							>
						...
						<div className='space-y-2'>
							{categories
								.slice(0, viewMore.categories ? categories.length : 5)
								.map(category => (
						...
						<div className='space-y-4'>
							<div className='flex items-center justify-between'>
								...
								<button
									className='text-xs text-gray-500'
									onClick={() =>
										setViewMore({ ...viewMore, brands: !viewMore.brands })
									}
								>
							...
							<div className='space-y-2'>
								{brands
									.slice(0, viewMore.brands ? brands.length : 5)
									.map(brand => (
						...
						<div className='space-y-4'>
							<div className='flex items-center justify-between'>
								...
								<button
									className='text-xs text-gray-500'
									onClick={() =>
										setViewMore({ ...viewMore, features: !viewMore.features })
									}
								>
							...
							<div className='space-y-2'>
								{features
									.slice(0, viewMore.features ? features.length : 5)
									.map(feature => (
				...
				<div className='flex-1'>
					<div className='flex flex-col gap-6'>
						...
						<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
							{data?.data?.products?.map((product: { id: Key | null | undefined; isNew: any; isSale: any; image: any; productName: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; price: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; originalPrice: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; rating: number; reviews: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; colors: any[] }) => (
								<div
									key={product.id}
